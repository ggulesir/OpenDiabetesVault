...
public class SensitivityDataset {
    public static List<VaultEntry> getSensitivityDataset() throws ParseException {
        ...
        //vaultEntries.add(new VaultEntry(VaultEntryType.MEAL_MANUAL, TimestampUtils.createCleanTimestamp("2016.04.18-09:14", "yyyy.MM.dd-HH:mm"), 5.6));
        ...
        vaultEntries.add(new VaultEntry(VaultEntryType.GLUCOSE_CGM, TimestampUtils.createCleanTimestamp("2016.04.18-10:43", "yyyy.MM.dd-HH:mm"), 166));
        ...
        vaultEntries.add(new VaultEntry(VaultEntryType.GLUCOSE_CGM, TimestampUtils.createCleanTimestamp("2016.04.18-10:59", "yyyy.MM.dd-HH:mm"), 177));
        ...
        vaultEntries.add(new VaultEntry(VaultEntryType.GLUCOSE_CGM, TimestampUtils.createCleanTimestamp("2016.04.18-11:14", "yyyy.MM.dd-HH:mm"), 184));
        vaultEntries.add(new VaultEntry(VaultEntryType.GLUCOSE_CGM, TimestampUtils.createCleanTimestamp("2016.04.18-11:29", "yyyy.MM.dd-HH:mm"), 192));
